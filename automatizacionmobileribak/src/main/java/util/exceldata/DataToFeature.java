...
public class DataToFeature {
	...
	/**
	 * Ingresa los datos obtenidos de un excel al archivo .feature del cual se
	 * est� llamando, hace que se genere la tabla en el escenario Outline como
	 * Data Table
	 *
	 * @since 27/11/2017
	 * @author bgaona
